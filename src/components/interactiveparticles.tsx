      ...
      {!effectiveSrc && (
        <div className="absolute text-center z-0 pointer-events-none">
          <p className="text-zinc-500 text-xs tracking-widest font-mono uppercase">
            [ Upload an image to scatter particles ]
          </p>
        </div>
      )}
      ...
      {allowUpload && (
        <>
          ...
          <button
            ...
            className="group absolute right-4 top-4 z-10 inline-flex items-center gap-1.5 rounded-full border border-white/10 bg-white/5 px-3 py-1.5 text-[11px] font-medium text-white/60 backdrop-blur-sm transition-all duration-200 hover:border-white/20 hover:bg-white/10 hover:text-white/90 cursor-pointer"
          >
            <svg
              width="12"
              height="12"
